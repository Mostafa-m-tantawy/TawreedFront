...
function useIsRTL() {
  ...
  React.useEffect(() => {
    if (typeof document !== "undefined")
      setDir(document?.documentElement?.dir || null);
  }, []);
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        "focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none",
        className
      )}
      checked={checked}
      {...props}
