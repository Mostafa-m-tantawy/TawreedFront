...
export default function OutgoingShipmentsTab({
  rows,
}: {
  rows: {
    id: string;
  ...
  const t = useTranslations("warehouse.outgoingShipmentsTab");
        ...
        <TableBody className="ty-body-sm text-neutral-black-800 border-0 text-start">
          {rows.map((r, idx) => (
            ...
            >
              ...
              <TableCell className="text-start">{r.destination}</TableCell>
